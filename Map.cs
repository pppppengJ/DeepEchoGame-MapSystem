...
namespace DeepEchoGame
{
    class Map
    {
        ...
        public void MonsterIn(int index)
        {
            Zones[index].MonsterIn();
        }

        public void MonsterOut(int index)
        {
            Zones[index].MonsterOut();
        }

        public void PrintZone(int index)
        {
            Zones[index].PrintZone();
        }
